...
abstract class $LoadingStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool isLoading, bool isPlaying});
}
...
class _$InitialImpl implements _Initial {
  const _$InitialImpl({this.isLoading = true, this.isPlaying = true});
  ...
  @override
  String toString() {
    return 'LoadingState(isLoading: $isLoading, isPlaying: $isPlaying)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, isLoading, isPlaying);
...
abstract class _Initial implements LoadingState {
  const factory _Initial({final bool isLoading, final bool isPlaying}) =
      _$InitialImpl;
