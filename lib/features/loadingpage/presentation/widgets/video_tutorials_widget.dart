...
class _VideoTutorialsWidgetState extends State<VideoTutorialsWidget> {
  ...
  void initState() {
    super.initState();
    context.read<LoadingPageCubit>().init();
  }

  @override
  void dispose() {
    context.read<LoadingPageCubit>().videoPlayerController.dispose();
    super.dispose();
  }
  ...
  Widget _buildVideoPlayer() {
    return Center(
      child: AspectRatio(
        aspectRatio: context
            .read<LoadingPageCubit>()
            .videoPlayerController
            .value
            .aspectRatio,
        child: Stack(
          children: [
            VideoPlayer(context.read<LoadingPageCubit>().videoPlayerController),
  ...
  Widget _buildControlButtons() {
    return Row(
      ...
      children: [
        IconButton(
          onPressed: context.read<LoadingPageCubit>().previousVideo,
        ...
        IconButton(
          onPressed: context.read<LoadingPageCubit>().nextVideo,
      ...
      child: Row(
        ...
        children: [
          ValueListenableBuilder(
            valueListenable:
                context.read<LoadingPageCubit>().videoPlayerController,
